class Review < ActiveRecord::Base
  after_save :calculate_reviewer_stats, :update_org_reviewers_list, :create_item
  include PgSearch
  ...
  attr_accessible  :organization_id, :reviewer, :reviewer_slug, :body, :rating, :processed, :reviewer_id, :title ,:review_provider_id
