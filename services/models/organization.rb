class Organization < ActiveRecord::Base
 # reverse_geocoded_by :latitude, :longitude
  ...
  attr_accessible :name, :street,:provider_slugs, :state, :cat_name, :country_code_id, :yahooslug, :latitude, :longitude, :street2, :postalcode, :city, :category, :phone1, :phone2, :url, :facebook, :twitter, :category_id, :reviewers_list, :account_id
  belongs_to :account
