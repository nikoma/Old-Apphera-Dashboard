...
ActiveRecord::Schema.define(:version => 20130208024300) do
  ...
  add_index "accounts", ["city"], :name => "index_accounts_on_city"
  add_index "accounts", ["country_code_id"], :name => "index_accounts_on_country_code_id"
  add_index "accounts", ["name"], :name => "index_accounts_on_name"
  add_index "accounts", ["reseller_id"], :name => "index_accounts_on_reseller_id"
  ...
  add_index "my_competitors", ["name"], :name => "index_my_competitors_on_name"
  ...
  add_index "organizations", ["cat_name"], :name => "index_organizations_on_cat_name"
  ...
  add_index "organizations", ["gmaps"], :name => "index_organizations_on_gmaps"
  ...
  add_index "provider_slugs", ["content_provider_id"], :name => "index_provider_slugs_on_content_provider_id"
  add_index "provider_slugs", ["organization_id"], :name => "index_provider_slugs_on_organization_id"
  ...
  add_index "reseller_commissions", ["reseller_id"], :name => "index_reseller_commissions_on_reseller_id"
  ...
  add_index "resellers", ["sub_domain"], :name => "index_resellers_on_sub_domain"
  ...
  add_index "twitter_users", ["from"], :name => "index_twitter_users_on_from"
  add_index "twitter_users", ["language"], :name => "index_twitter_users_on_language"
  ...
  add_index "users", ["is_reseller"], :name => "index_users_on_is_reseller"
  ...
  add_index "web_contents", ["job_id"], :name => "index_web_contents_on_job_id"
  add_index "web_contents", ["user_id"], :name => "index_web_contents_on_user_id"
